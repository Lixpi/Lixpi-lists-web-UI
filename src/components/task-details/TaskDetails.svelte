...
<div class="task-details {classNames}">
    <div class="task-header">
        <div class="d-flex justify-content-start align-items-center mb-4">
            ...
            <h2 class="project-title"><span>{task.project} <i>/</i></span> {task.key}</h2>
        </div>
        <ColorCodedRow colorCode={mapPriorityToColor(task.priority)} classNames="no-hover task-details-meta-row">
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <p>Priority: <b class="text-color-{mapPriorityToColor(task.priority)}">{task.priority}</b></p>
