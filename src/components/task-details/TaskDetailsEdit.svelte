<script>
    ...
    let versions = [
      ...
      {value: 2, label: 'Alpha'},
      {value: 3, label: 'Beta'},
      {value: 4, label: 'Shitty but good enough for release'}
    ]
    let selectedVersion = [versions[0]]
    let isVersionSelectDisabled = true
...
<div class="task-details {classNames}">
    <div class="task-header">
        <div class="d-flex justify-content-start align-items-center mb-4">
            ...
            <h5 class="project-title"><span>task.project.title <i>/</i></span> task.key</h5>
        </div>
        <div class="d-flex justify-content-start align-items-center mb-4">
            <!-- <img class="project-logo noselect" src="/system-images/logo.png" alt="task.project.title" /> -->
